      ...
      <main className="max-w-4xl mx-auto px-4 py-8 print:hidden">
        <div className="space-y-8">
          ...
          <section className="space-y-6">
            ...
            >
              <Plus size={20} /> Añadir Nueva Actividad2
            </button>
          </section>
              ...
              <React.Fragment key={activity.id}>
                {activity.images.length === 0 ? (
                  <tr className="break-inside-avoid">
                    ...
                    <td className="border border-black p-2 align-middle text-gray-300 text-center italic text-sm">
                  ...
                  activity.images.map((img, imgIdx) => (
                    <tr key={imgIdx} className="break-inside-avoid">
                      {imgIdx === 0 && (
                        <td rowSpan={activity.images.length} className="border border-black text-center align-middle p-2 font-bold text-lg bg-gray-50/30">
                          {index + 1}
                        </td>
                      )}
                      <td className="border border-black p-2 align-middle text-center">
                        ...
                        <img 
                          ...
                          className="max-w-full h-auto max-h-55 object-contain inline-block border border-gray-100 p-0.5" 
                        />
                      </td>
                      <td className="border border-black p-4 align-middle">
                        {imgIdx === 0 && activity.description && (
                          <div className="mb-3 pb-3 border-b border-gray-200">
                            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block mb-1">Descripción General de la Actividad</span>
                            <p className="text-justify whitespace-pre-line text-[13px] text-gray-900 font-medium">
                              {activity.description}
                            </p>
                          </div>
                        )}
                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block mb-1">Descripción de la Foto</span>
                        <p className="text-justify whitespace-pre-line text-[13px] text-gray-800 leading-snug">
                          {img.description || "Sin descripción de la foto."}
                        </p>
                      </td>
                    </tr>
                  ))
